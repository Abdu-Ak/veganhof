...
function Contact() {
  return (
    <>
      <section id="contact" class=" relative p-8 md:p-16 lg:p-20 xl:p-24 z-10 overflow-hidden bg-gray-100 py-12 md:py-20 lg:py-32">
        <div class="container mx-auto">
          <div class="-mx-4 flex flex-wrap lg:justify-between">
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div class="mb-8 md:mb-12 max-w-md md:max-w-[570px] lg:mb-0">
                <span class="text-[#7cc68d] mb-2 md:mb-4 block text-sm md:text-base font-semibold">
                  Contact Us
                </span>
                <h2 class="md:text-3xl text-2xl font-mono tracking-widest font-semibold text-center text-[#171717]">
                  GET IN TOUCH WITH US
                </h2>
                <p class="text-body-color mb-4 md:mb-9 text-base md:text-lg leading-relaxed">
                  We'd love to hear from you! If you have any questions,
                  feedback, or inquiries about our organic protein smoothie
                  powders, don't hesitate to reach out to us.
                </p>

                <div class="mb-4 md:mb-8 flex w-full max-w-[300px] md:max-w-[370px]">
                  <div class="bg-primary text-primary mr-4 md:mr-6 flex h-[50px] w-full max-w-[50px] md:h-[60px] md:w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                  ...
                  <div class="flex-1">
                    ...
                    <p class="text-body-color text-base">
                      36/13, 35B, Aventura Mall, Mall Road Amritsar, Punjab,
                      143001, India
                    </p>
                  </div>
                </div>
            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div class="relative bg-white py-6 px-8 md:px-10 lg:px-12 xl:px-16 shadow-md rounded-lg">
                <form>
                  <div class="mb-6">
                    <input
                      type="text"
                  ...
                  <div>
                    <button
                      type="submit"
                      class="bg-[#7cc68d] border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
